...
function getThemeMarkdown(urlPrefix: string): string {
    let result = '';
    result += `
[![](${urlPrefix}/0-profile-details.svg)](https://github.com/mohitkumhar/github-profile-summary-cards)
[![](${urlPrefix}/1-repos-per-language.svg)](https://github.com/mohitkumhar/github-profile-summary-cards) [![](${urlPrefix}/2-most-commit-language.svg)](https://github.com/mohitkumhar/github-profile-summary-cards)
[![](${urlPrefix}/3-stats.svg)](https://github.com/mohitkumhar/github-profile-summary-cards) [![](${urlPrefix}/4-productive-time.svg)](https://github.com/mohitkumhar/github-profile-summary-cards)
`;
    return result;
}
